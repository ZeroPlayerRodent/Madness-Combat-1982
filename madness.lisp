...
(loop
  ...
  (loop
    ...
    (when (> (random) 220)
      (plot bgy bgx 104)
      (plotcolor bgy bgx 11)
      (when (> (random) 125)
        (plotcolor bgy bgx 12)
      )
    )
    (put (+ bgx 1) bgx)
  )
...
(newarray startmessage 77 65 68 78 69 83 83 96 67 79 77 66 65 84 0)
